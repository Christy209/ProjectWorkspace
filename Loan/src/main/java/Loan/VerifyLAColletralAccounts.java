...
public class VerifyLAColletralAccounts extends BaseTest{
	   protected static WebDriver driver;
	    ...
	    @ExcelData(sheetName = "Sheet5", rowIndex = {1, 2})
...
//	        }
	    ...
	    private static Map<String, String> getApplicationData(WebDriver driver, WebDriverWait wait2) throws Exception {
	        ...
	        appData.put("collateralCode", ExcelUtils.getTextOrValue(driver, wait, "collateralCode", "id"));
	        appData.put("entityId", ExcelUtils.getTextOrValue(driver, wait, "entityId", "id"));
	        appData.put("apportionedAmt", ExcelUtils.getTextOrValue(driver, wait, "apportionedAmt", "id"));
