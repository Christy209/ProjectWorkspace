...
public class VerificationOfOD extends BaseTest {
	  protected static WebDriver driver;
	    ...
	    @ExcelData(sheetName = "Sheet3", rowIndex = {1, 3})
...
//		                try {
//		                    WebDriverWait shortWait = new WebDriverWait(driver, Duration.ofSeconds(3));
//		                    WebElement acceptBtn = shortWait.until(ExpectedConditions.elementToBeClickable(By.id("accept")));
//		                    acceptBtn.click();
//		                    System.out.println("✅ Accept button clicked.");
//		                } catch (Exception e) {
//		                    System.out.println("⚠️ Accept button not found, trying with Robot...");
//		                    Robot robot = new Robot();
//		                    robot.setAutoDelay(500);
//		                    robot.keyPress(KeyEvent.VK_TAB);
//		                    robot.keyRelease(KeyEvent.VK_TAB);
