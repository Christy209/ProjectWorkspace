...
public class TC10_AdviseDocumentaryCredit {
	 ...
	 private WebDriverWait  wait;
	    ...
	    public void runTest() throws Exception {
	        String logFile = TestResultLogger.createLogFile("TC10_AdviseDocumentaryCredit");
	        ...
	        try {
	            ...
	            RowData id = ExcelUtils.getRowAsRowData("TC10", 1);
	            RowData verifyData = ExcelUtils.getRowAsRowData("TC10", 2);

	            login.First();

	            Map<String, String> result = new InwardDocumentaryCreditsMaintenance(driver).execute(id,id, "TC10", 1, excelPath);  
	            ...
	            ExcelUtils.loadExcel(excelPath);
	            id = ExcelUtils.getRowAsRowData("TC10", 1);
	            login.Second();

	            Map<String, String> Verifyresult  = new InwardDocumentaryCreditsMaintenance(driver).execute(verifyData,id, "TC10", 2, excelPath);
