...
public class TC12_ReinstatingTheDocumentaryCredit {
	 ...
	 private WebDriverWait  wait;
	    ...
	    public void runTest() throws Exception {
	        String logFile = TestResultLogger.createLogFile("TC12_ReinstatingTheDocumentaryCredit");
	        ...
	        try {
	            ...
	            RowData id = ExcelUtils.getRowAsRowData("TC12", 1);
	            RowData verifyData = ExcelUtils.getRowAsRowData("TC12", 2);

	            login.First();

	            Map<String, String> result = new InwardDocumentaryCreditsMaintenance(driver).execute(id,dcno, "TC12", 1, excelPath);  
	            ...
	            Map<String, String> Verifyresult  = new InwardDocumentaryCreditsMaintenance(driver).execute(verifyData,dcno, "TC12", 2, excelPath);
