	...
	private WebDriverWait wait;
	    ...
	    public String execute(RowData inputData ,List<String> vr, String sheetname,int row,String excelpath) throws Exception {
	        WindowHandle.slowDown(4);
	            ...
	            WindowHandle.setValueWithJS(driver,wait.until(ExpectedConditions.presenceOfElementLocated(By.id("menuSelect"))),vr.get(1));
	    ...
	    private static Map<String, String> getApplicationData(WebDriver driver ,WebDriverWait wait) throws Exception {
		    ...
		    appData.put("FwdCntrctNo", actualType);
