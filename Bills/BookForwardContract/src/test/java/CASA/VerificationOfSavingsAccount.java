...
public class VerificationOfSavingsAccount extends BaseTest{
	 private WebDriver driver;
	 private WebDriverWait wait;

	    public VerificationOfSavingsAccount(WebDriver driver) {
	    	this.driver = driver;
	        this.wait = new WebDriverWait(driver, Duration.ofSeconds(10)); 
	    }
     public String execute(RowData id, List<String> verifyData) throws Exception {

			   	WebElement searchbox = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("menuSelect")));
		        searchbox.click();
		        searchbox.sendKeys(verifyData.get(1));
		        ...
		        funCode.sendKeys(verifyData.get(2));
	            ...
	            ((JavascriptExecutor) driver).executeScript("arguments[0].value=arguments[1];", acctID ,AcctID);
		    	   ...
		    	   Validation.validateData(id.getHeaderMap(),appData);
