...
public class VerificationOfCashWithdrawal {
	  private WebDriver driver;
	    private WebDriverWait wait;

	    public VerificationOfCashWithdrawal(WebDriver driver) {
	        this.driver = driver;
	        this.wait = new WebDriverWait(driver, Duration.ofSeconds(10)); 
	    }
    public void execute(RowData id ,RowData tranId,List<String> vcw , String sheetname,int idrow,int cwrow,String excelpath) throws Exception {
    	
        WebElement searchbox = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("menuSelect")));
        searchbox.click();
        searchbox.sendKeys(vcw.get(1));
        ...
        //String tranIdValue = "M775";// Store TranID for later use
        ...
        Row row1 = sheet.getRow(idrow);
        Row row = sheet.getRow(cwrow); // 0-based index
