...
import CustomMenu.PradhanMantriSurakshaBimaYojna;
import Utilities.ExcelUtils;
import Utilities.LogOut;
import Utilities.Login;

public class TC01_AddVerifyAndCancelPradhanMantriSurakshaBimaYojna {

    private WebDriver driver;
    private WebDriverWait wait;

    private static final String EXCEL_PATH = System.getProperty("user.dir") + "/Resource/CustomData.xlsx";
    private static final String SHEET = "TC02";
    ...
    public void runTest() throws Throwable {
        ...
        login.Second();
        executeStep("Verify", 2);
        
        // 2) Cancel
        executeStep("Cancel", 3);
    ...
    private void executeStep(String action, int row) throws Throwable {
        ...
        try {
            new PradhanMantriSurakshaBimaYojna(driver).execute(data, EXCEL_PATH, SHEET, row);
