...
import Positive.AddingHddsm;
import Positive.Cancelhddsm;

public class TC28_AddingAndModifyingHDDSM {
	 @Test
	    public void runTestSuiteInOrder() {
	       ...
	       classes.add(new XmlClass(AddingHddsm.class.getName()));              
	       classes.add(new XmlClass(Cancelhddsm.class.getName()));   
