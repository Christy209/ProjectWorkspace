...
import Positive.AddHDDSM;
import Positive.VerifyHDDSM;

public class TC26_AddHDDSMAndVerifyHDDSM {
	 @Test
	    public void runTestSuiteInOrder() {
	       ...
	       classes.add(new XmlClass(AddHDDSM.class.getName()));              
	       classes.add(new XmlClass(VerifyHDDSM.class.getName()));   
