...
public class TC15_Invokeguaranteeaftermarkingitforinvocation {
    ...
    public void runTest() throws Exception {
        ...
        try {
            ...
            String markLabelText = markInvokeResult.get("LabelText");
            assertGuaranteeCaptured(markInvokeGuaranteeNo, "Mark Invoke");
            logStep("✅ " + markLabelText);
            passedTests++;
            ...
            assertGuaranteeCaptured(guaranteeNo, "Verify");
            logStep("✅ " + labelText);
            passedTests++;
            ...
            // 🔹 Save logs as HTML and attach to Allure
            saveDocumentViewCopy(startTime, LocalDateTime.now());

            // 🔹 Attach consolidated log as plain text too
            Allure.addAttachment("TC15 Consolidated Log", "text/plain", testLog.toString());
        }
    }
    ...
    private void saveDocumentViewCopy(LocalDateTime startTime, LocalDateTime endTime) {
        try {
            ...
            File outputFile = new File(folder, "TC15_Document_" + timestamp + ".html");

            try (FileWriter writer = new FileWriter(outputFile)) {
                writer.write("<!DOCTYPE html><html><head><meta charset='UTF-8'>");
                writer.write("<title>TC15 Document View</title>");
                writer.write("<style>");
                ...
                writer.write("<h2>📄 Test Case: TC15_Invokeguaranteeaftermarkingitforinvocation</h2>");
                ...
                writer.write("📊 Suite Summary: TC15_Invokeguaranteeaftermarkingitforinvocation<br>");
            ...
            try (InputStream is = Files.newInputStream(outputFile.toPath())) {
                Allure.addAttachment("TC15 Document View", "text/html", is, ".html");
            }
