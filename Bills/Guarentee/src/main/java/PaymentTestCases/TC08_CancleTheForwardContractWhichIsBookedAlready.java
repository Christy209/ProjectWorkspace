...
public class TC08_CancleTheForwardContractWhichIsBookedAlready {
	    ...
	    public void runTest() throws Exception {
	        String logFile = TestResultLogger.createLogFile("TC08_CancleTheForwardContractWhichIsBookedAlready");
	        Login login = new Login();

	        try {
	            RowData fwdcno = ExcelUtils.getRowAsRowData(SHEET_NAME, 1);
	            RowData inputData = ExcelUtils.getRowAsRowData(SHEET_NAME, 2);
	...
	//
	            // ---------------- Step 2: Mark Invoke ----------------
	            Map<String, String> Book = FrwConNo.execute(fwdcno,fwdcno ,SHEET_NAME, 1, EXCEL_PATH);
	            ...
	            Map<String, String> Cancel = FrwConNo.execute(inputData,fwdcno ,SHEET_NAME, 2, EXCEL_PATH);
		        ...
		        Map<String, String> Verifyresult = VMNTFWC.execute(fwdcno,VerifyData ,SHEET_NAME, 3, EXCEL_PATH);
