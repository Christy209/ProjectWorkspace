...
import bhatinda.LoanAccountOpening;
import bhatinda.LoanClose;

public class TC02_LoanAccountOpeningAndClose {
    ...
    public void runTestSuiteInOrder() {
       ...
       classes.add(new XmlClass(LoanAccountOpening.class.getName()));              
       classes.add(new XmlClass(LoanClose.class.getName()));  
