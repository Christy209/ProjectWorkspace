...
import Positive.Dowithdrwaltotaldebitfreezeaccount;


public class TC01_DoWithdrawalForDebitFreezeAccount {
    ...
    public void runTestSuiteInOrder() {
       ...
       classes.add(new XmlClass(Dowithdrwaltotaldebitfreezeaccount.class.getName()));              
