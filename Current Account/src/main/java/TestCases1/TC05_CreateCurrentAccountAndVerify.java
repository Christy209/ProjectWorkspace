...
import Positive.CreateCurentAccount;
import Positive.VerificationOfCurrentAccount;

public class TC05_CreateCurrentAccountAndVerify {
	 @Test
	    public void runTestSuiteInOrder() {
	       ...
	       classes.add(new XmlClass(CreateCurentAccount.class.getName())); 
	       classes.add(new XmlClass(VerificationOfCurrentAccount.class.getName())); 
