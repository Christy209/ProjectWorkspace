...
public class CreateOdWithColletralLinkage extends BaseTest{
	...
	@ExcelData(sheetName = "Sheet6", rowIndex = 1)
...
try {
	 ...
	 WindowHandle.checkForApplicationErrors(driver);
	            ...
	            WindowHandle.setValueWithJS(driver, wait.until(ExpectedConditions.presenceOfElementLocated(By.id("collateralCode"))),inputData.getByIndex(50));
	            WindowHandle.setValueWithJS(driver, wait.until(ExpectedConditions.presenceOfElementLocated(By.id("entityId"))),inputData.getByIndex(51));
	            WindowHandle.setValueWithJS(driver, wait.until(ExpectedConditions.presenceOfElementLocated(By.id("apportionedAmt"))),inputData.getByIndex(52));
