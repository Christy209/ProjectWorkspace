...
public class VerifyCancel extends BaseTest{
	
	public class Closetheaccountwithzerobalance extends BaseTest{
	...
	@Test(dataProvider ="testcase", dataProviderClass = Dataproviders.class)
	   @ExcelData(sheetName ="Sheet3",rowIndex= {1,2} )
	   public void closing(RowData input,RowData id) throws Exception 
	{
	   	...
	   	((JavascriptExecutor) driver).executeScript("arguments[0].click();", searchButton);
		       ...
		       try {
		           ...
		           String AcctID = input.getByHeader("accid");
