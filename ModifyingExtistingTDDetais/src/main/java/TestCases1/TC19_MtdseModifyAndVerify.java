...
import Positive.MTDSE;
import Positive.MTDSEVerify;

public class TC19_MtdseModifyAndVerify {
	  ...
	  @Test
	    public void runTestSuiteInOrder() {
	       ...
	       classes.add(new XmlClass(MTDSE.class.getName()));              
	       classes.add(new XmlClass(MTDSEVerify.class.getName()));   
