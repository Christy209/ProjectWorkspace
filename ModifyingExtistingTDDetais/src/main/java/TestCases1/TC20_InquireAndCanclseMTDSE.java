...
import Positive.CancelMTDSE;
import Positive.InquireMTDSE;

public class TC20_InquireAndCanclseMTDSE {
	 ...
	 @Test
	    public void runTestSuiteInOrder() {
	       ...
	       classes.add(new XmlClass(InquireMTDSE.class.getName()));              
	       //classes.add(new XmlClass(CancelMTDSE.class.getName()));   
