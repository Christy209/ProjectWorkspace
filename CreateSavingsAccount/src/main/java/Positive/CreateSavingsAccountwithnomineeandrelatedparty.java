...
public class CreateSavingsAccountwithnomineeandrelatedparty {
	 ...
	 String excelpath = System.getProperty("user.dir") + "/resources/TestData.xlsx";
	    ...
	    public void CreateLoan(RowData inputData) throws Exception {
		    	...
		    	try {
			          ...
			          WindowHandle.setValueWithJS(driver,wait.until(ExpectedConditions.presenceOfElementLocated(By.id("permForacid"))),inputData.getByIndex(5));
