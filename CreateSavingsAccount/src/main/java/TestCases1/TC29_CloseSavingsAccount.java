...
import Positive.CloseSavingAccountWithNomineeDetails;


public class TC29_CloseSavingsAccount {
	  ...
	  @Test
	    public void runTestSuiteInOrder() {
	       ...
	       classes.add(new XmlClass(CloseSavingAccountWithNomineeDetails.class.getName()));              
