...
public class TC07_ExtendAForWardContractToTwoYears {
	    ...
	    public void runTest() throws Exception {
	        String logFile = TestResultLogger.createLogFile("TC07_ExtendAForWardContractToTwoYears");
	...
	//
		        ...
		        Map<String, String> Verifyresult = VMNTFWC.execute(fwdcno,VerifyData ,SHEET_NAME, 2, EXCEL_PATH);
