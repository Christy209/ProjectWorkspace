...
public class TC01_Payments_LodgeOutwardBill {
    ...
    public void runTest() throws Exception {
        ...
        try {
            ...
            String labelText = result.get("labelText"); // primary key
            if (labelText == null || labelText.isEmpty()) {
                labelText = result.get("LABELTEXT_BILLID"); // fallback
            }
            ...
            String verifyLabelText = Verifyresult.get("labelText"); // primary key
