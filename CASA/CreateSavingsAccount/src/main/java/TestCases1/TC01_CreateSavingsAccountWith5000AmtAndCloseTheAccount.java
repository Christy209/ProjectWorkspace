...
public class TC01_CreateSavingsAccountWith5000AmtAndCloseTheAccount {
    ...
    public void runTestSuiteInOrder() {
       ...
       classes.add(new XmlClass(CreateSavingsAccountwithnomineeandrelatedparty.class.getName()));              
       classes.add(new XmlClass(VerifyingCreateSavingsAccountwithnomineeandrelatedparty.class.getName()));   
