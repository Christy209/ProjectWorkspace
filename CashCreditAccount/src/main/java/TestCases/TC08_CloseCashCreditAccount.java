...
import CashCreditAccount.CloseCashCreditAccount;

public class TC08_CloseCashCreditAccount {
	 @Test
	    public void runTestSuiteInOrder() {
	       ...
	       classes.add(new XmlClass(CloseCashCreditAccount.class.getName()));              // HCAAC
