...
public class CreateSavingsAccount extends BaseTest {
	 ...
	 private WebDriverWait wait;
	    ...
	    public CreateSavingsAccount(WebDriver driver) {
	       ...
	       public void execute(RowData inputData , String sheetname,int row,String excelpath) throws Exception {
		  
		  	String mainWindowHandle = driver.getWindowHandle();

	        WebElement searchbox = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("menuSelect")));
	        searchbox.click();
	        searchbox.sendKeys(inputData.getByIndex(1));
